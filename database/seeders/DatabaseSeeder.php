...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        foreach ($subKriteria as $data) {
            // Simpan data sub_kriteria
            $subKriteriaId = SubKriteria::table('sub_kriteria')->insertGetId([
                'kriteria_id' => $data['kriteria_id'],
                'nama' => $data['nama'],
                'bobot' => $data['bobot']
            ]);

            // Simpan data penilaian terkait
            foreach ($data['penilaian'] as $penilaian) {
                SubKriteria::table('penilaian')->insert([
                    'sub_kriteria_id' => $subKriteriaId,
                    'rentang' => $penilaian['rentang'],
                    'skor' => $penilaian['skor']
                ]);
            }
        }
